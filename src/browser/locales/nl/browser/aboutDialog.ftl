...
update-checkingForUpdates = Checken op updates…
...
update-failed = Update mislukt. <a data-l10n-name="failed-link-main">Download de nieuwste versie</a>
...
channel-description = U gebruikt momenteel het <label data-l10n-name="current-channel"></label> update-kanaal.

warningDesc-version = { -brand-short-name } warningDesc-version = { -brand-short-name } is experimenteel en kan onstabiel zijn.
